...
MODEL_PROFILES: dict[str, dict] = {
    ...
    # MiniCPM5-2B (openbmb): LlamaForCausalLM, thinking via template
    # (enable_thinking), XML-style tool calls handled by --jinja.
    "minicpm5":    {"thinking": True, "vision": False, "tool_call": True},
